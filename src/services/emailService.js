...
const templates = {
  ...
  videoReady: (projectName, versionTitle, portalUrl) => wrapTemplate('Nouvelle vidéo disponible', `<p>Une nouvelle version de votre projet <strong>${projectName}</strong> est disponible : ${versionTitle}.</p><p><a href="${portalUrl}" style="color:#0A84FF">Connectez-vous à votre espace client</a> pour la visionner et laisser vos retours.</p>`),
